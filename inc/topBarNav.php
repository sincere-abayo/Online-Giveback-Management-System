<nav class="navbar navbar-expand-lg navbar-dark bg-navy">
  ...
  <label class="btn btn-outline-primary btn-sm" for="btnradio1">
                        ...
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="index.php" style="font-weight:bold;color:#fff;">Home</a></li></label>
                  

                        <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off">
  <label class="btn btn-outline-primary btn-sm" for="btnradio3">
                      
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="?p=events" style="font-weight:bold;color:#fff;">Events</a></li></label>

  <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
  <label class="btn btn-outline-primary btn-sm " for="btnradio2">

                        <li class="nav-item"><a class="nav-link" aria-current="page" href="?p=causes" style="font-weight:bold;color:#fff;">Our Team</a></li></label>
        

                        <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
  <label class="btn btn-outline-primary btn-sm" for="btnradio4">
                        
                        <li class="nav-item"><a class="nav-link" href="<?php echo base_url ?>?p=about" style="font-weight:bold;color:#fff;">About</a></li></label>

                        <input type="radio" class="btn-check" name="btnradio" id="btnradio5" autocomplete="off">
  <label class="btn btn-outline-primary btn-sm" for="btnradio5">

                        <li class="nav-item"><a class="nav-link" aria-current="page" href="?p=gallery" style="font-weight:bold;color:#fff;">Gallery</a></li></label>
...
<script>
  ...
  <script>$(function(){
    ...
    $('#checkout').click(function(){
      uni_modal('checkout','checkout.php')
    })
  })</script>