...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Rejected Volunteer</h3>
        ...
        <div class="container-fluid">
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as fullname from `volunteer_list`where status = '2' order by concat(lastname,', ',firstname,' ',middlename) asc ");
...
<noscript id="print-header">
    <div class="row bg-dark">
        ...
        <div class="col-8">
            ...
            <h3 class="text-center"><b>Rejected Volunteer</b></h3>
        </div>
        <div class="col-2"></div>
    </div>
</noscript>
<script>
    $(function() {
        ...
        $('.view_data').click(function(){
			uni_modal("Report Details","volunteerview_volunteer.php?id="+$(this).attr('data-id'),"mid-large")
		})
       ;
        $('#print').click(function(){
            ...
            _el.append(_h)
            _el.append(_ph)
            _el.find('title').text('Rejected Volunteer Report')
            _el.append(_p)
