    ...
    <noscript id="print-header">
        ...
        $(function() {
            ...
            $('#delete_volunteer').click(function() {
                _conf("Are you sure to delete this  Information?", "donation/delete.php", [
                    '<?= isset($id) ? $id : '' ?>'
                ])
            })
            $('.view_data').click(function() {
                uni_modal("Donation Details", "donation/view.php?id=" + $(this).attr('data-id'),
                    "mid-large")
            });
