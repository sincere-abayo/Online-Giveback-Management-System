                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" name="volunteer_id" value="<?php if(isset($_GET['volunteer_id'])){echo $_GET['volunteer_id'];} ?>" class="form-control" placeholder="E-mail">
                                </div>
                                <div class="col-md-4">
...
<div class="form-group mb-3">
    ...
    <input type="hidden" value="<?= $status_label ?>" class="form-control" disabled>
                                ...
                                ?>
                                  ...
                                  <a class="btn btn-primary" href="./index.php">Use Contact</a> <img src="../img/passport.png" style="width: 30px;margin-bottom:-2px;color: #fff;"> OR
                                 <a class="btn btn-primary" href="./index1.php">Use E-mail </a><img src="../img/gmail.png" style="width: 30px;margin-bottom:-2px;color: #fff;">
            </div>
<div class="row">
