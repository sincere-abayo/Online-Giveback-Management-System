    ...
    <h3>Image Gallery</h3>
                ...
                ?>  
                    <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>  
                        <a class="thumbnail fancybox" rel="ligthbox" href="./admin/gallerie/uploads/<?php echo $image['image'] ?>">  
                            <img class="img-responsive" alt="" src="./admin/gallerie/uploads/<?php echo $image['image'] ?>" />  
