    ...
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a class="btn btn-sm btn-primary btn-flat" href="./?page=volunteer/manage_volunteer&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Edit</a>
                <button class="btn btn-sm btn-navy bg-navy btn-flat" type="button" id="add_shelter"><i class="fa fa-plus"></i> Assign Program/Activity</button>
                <button class="btn btn-sm btn-success bg-success btn-flat" type="button" id="print"><i class="fa fa-print"></i> Print</button>
                <a href="./?page=volunteer" class="btn btn-default border btn-sm btn-flat"><i class="fa fa-angle-left"></i> Back to List</a>
            </div>
        </div>
        <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1 align-middle">
                                    <small><span class=""><?= $row['program'] ?></span></small><br>
                                ...
                                <td class="px-2 py-1 align-middle text-center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item edit_shelter" href="javascript:void(0)" data-id ="<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Update</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
