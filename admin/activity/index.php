...
<script>
	$(document).ready(function(){
        ...
        $('.edit_data').click(function(){
			uni_modal("Update Activity Details","activity/manage_activity.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Camp permanently?","delete_activity",[$(this).attr('data-id')])
		})
