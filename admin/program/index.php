            ...
            <div class="container-fluid">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        <?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `program_list` where delete_flag = 0 order by `name` asc ");
...
$(document).ready(function() {
    $('#create_new').click(function() {
        uni_modal("Add New Program", "program/manage_program.php")
    })
    $('.view_data').click(function() {
        uni_modal("Program Details", "program/view_program.php?id=" + $(this).attr('data-id'))
    })
    $('.edit_data').click(function() {
        uni_modal("Update Program Details", "program/manage_program.php?id=" + $(this).attr('data-id'))
    })
    $('.delete_data').click(function() {
        _conf("Are you sure to delete this Program permanently?", "delete_program", [$(this).attr(
            'data-id')])
    })
