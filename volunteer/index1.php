                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <input type="text" name="volunteer_id"
                                                                value="<?php if(isset($_GET['volunteer_id'])){echo $_GET['volunteer_id'];} ?>"
                                    ...
                                    if(isset($_GET['volunteer_id']))
                                    {
                                        ...
                                        $query = "SELECT * FROM volunteer_list WHERE email='$volunteer_id' ";
                                            ...
                                            foreach($query_run as $row)
                                            {
                                                ?>
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text"
                                                                value="<?= $row['firstname']; ?>  <?= $row['middlename']; ?>  <?= $row['lastname']; ?>"
                                                                class="form-control" disabled>
                                                        </div>
                                                        <div class="form-group mb-3">
                                                            <label for="">E-mail & Contact</label>
                                                            <input type="text"
                                                                value="<?= $row['email']; ?>/<?= $row['contact']; ?>"
                                                                class="form-control" disabled>
                                                        </div>
...
?>
                                                        <div class="form-group mb-3">
                                                            <label for="status">Status</label><br> <small>
                                                                <span
                                                                    class="rounded-pill <?= $status_class ?> px-3"><?= $status_label ?></span>
                                                            </small></small>
                                                            <input type="hidden" value="<?= $status_label ?>"
                                                                class="form-control" disabled>
                                ...
                                ?>
                                                        <b>
                                                            <div class="col-6 mb-5">
                                                                <a class="btn btn-primary" href="./index.php">Use
                                                                    Contact</a> <img src="../img/passport.png"
                                                                    style="width: 30px;margin-bottom:-2px;color: #fff;">
                                                                OR
                                                                <a class="btn btn-primary" href="./index1.php">Use
                                                                    E-mail </a><img src="../img/gmail.png"
                                                                    style="width: 30px;margin-bottom:-2px;color: #fff;">
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-8 mb-5">
                                                                    <b><img src="../img/back.png"
                                                                            style="width: 30px;margin-bottom:-2px;color: #fff;"><a
