    ...
    <div class="row d-flex justify-content-center">
        <div class="col-sm-12">
            <div class="card mx-auto">
                ...
                <p class="heading">__Airtel__</p>
                    <form class="card-details " action="checkout_op.php" method="post">
                    <input type="hidden" id="provider" name="provider" value="airtel" />
                    ...
                    <input type="text" name="fullname" placeholder="Enter your full name" class="" value="" required>
                        ...
                        <div class="form-group mb-0">
                                ...
                                <input type="tel" name="card-num" placeholder="+250-73X-XXX-XXX" size="15" id="cno" minlength="10" maxlength="10" value="" required>

                                
                                <img onclick="location.href='checkout_mtn.php'; " src="mtn.png" class="mx-2" width="64px" height="60px" onclick="setProvider('AIRTEL')" style="cursor:pointer;" />
                                
                                <img onclick="location.href='checkout_air.php?'; " src="airtel.png" class="mx-3" width="64px" height="60px" onclick="setProvider('MTN')" style="cursor:pointer;" />
